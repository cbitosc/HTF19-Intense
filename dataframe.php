...
echo '<center>';
echo '<style> div.card:hover,card-subtitle mb-2 text-muted:hover{background-color: black;color: white;}</style>';
...
$sql = "SELECT REGION,DISTRICT,STATE FROM POWERDB GROUP BY REGION HAVING COUNT(*) >= 1 ORDER BY COUNT(*) DESC";
